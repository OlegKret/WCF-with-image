...
namespace BookServise.ServiceReference2 {
    ...
    public interface IAccount {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://OlegKret.somee.com/BOOOOK/IAccount/UploadFile", ReplyAction="http://OlegKret.somee.com/BOOOOK/IAccount/UploadFileResponse")]
        void UploadFile(string localFile, string remoteFile);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://OlegKret.somee.com/BOOOOK/IAccount/UploadFile", ReplyAction="http://OlegKret.somee.com/BOOOOK/IAccount/UploadFileResponse")]
        System.Threading.Tasks.Task UploadFileAsync(string localFile, string remoteFile);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://OlegKret.somee.com/BOOOOK/IAccount/ByteToImage", ReplyAction="http://OlegKret.somee.com/BOOOOK/IAccount/ByteToImageResponse")]
        System.Drawing.Bitmap ByteToImage(byte[] blob);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://OlegKret.somee.com/BOOOOK/IAccount/ByteToImage", ReplyAction="http://OlegKret.somee.com/BOOOOK/IAccount/ByteToImageResponse")]
        System.Threading.Tasks.Task<System.Drawing.Bitmap> ByteToImageAsync(byte[] blob);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://OlegKret.somee.com/BOOOOK/IAccount/DownloadFile", ReplyAction="http://OlegKret.somee.com/BOOOOK/IAccount/DownloadFileResponse")]
        byte[] DownloadFile(string url);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://OlegKret.somee.com/BOOOOK/IAccount/DownloadFile", ReplyAction="http://OlegKret.somee.com/BOOOOK/IAccount/DownloadFileResponse")]
        System.Threading.Tasks.Task<byte[]> DownloadFileAsync(string url);
    }
    ...
    public partial class AccountClient : System.ServiceModel.ClientBase<BookServise.ServiceReference2.IAccount>, BookServise.ServiceReference2.IAccount {
        ...
        public void UploadFile(string localFile, string remoteFile) {
            base.Channel.UploadFile(localFile, remoteFile);
        }
        
        public System.Threading.Tasks.Task UploadFileAsync(string localFile, string remoteFile) {
            return base.Channel.UploadFileAsync(localFile, remoteFile);
        }
        
        public System.Drawing.Bitmap ByteToImage(byte[] blob) {
            return base.Channel.ByteToImage(blob);
        }
        
        public System.Threading.Tasks.Task<System.Drawing.Bitmap> ByteToImageAsync(byte[] blob) {
            return base.Channel.ByteToImageAsync(blob);
        }
        
        public byte[] DownloadFile(string url) {
            return base.Channel.DownloadFile(url);
        }
        
        public System.Threading.Tasks.Task<byte[]> DownloadFileAsync(string url) {
            return base.Channel.DownloadFileAsync(url);
        }
    }
}
